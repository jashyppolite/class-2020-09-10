...
ggplot(x, aes(x = mean_age)) + 
  ...
  xlim(c(30,55)) +
  labs(title = "Average Age of Voters in the Kenya", x = "Age", y = "Number of Voters")
#the plot tells us that the general age of Kenyas voting population has higher
#representation of middle aged people usually in their early to mid forties
```
...
### Scene 3
```{r}
ggplot(x, aes(x = reg_inc)) + geom_histogram(bins = 50, color = "white") +
